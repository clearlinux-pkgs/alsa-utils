...
Source0  : https://www.alsa-project.org/files/pub/utils/alsa-utils-1.2.13.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/utils/alsa-utils-1.2.13.tar.bz2.sig
...
Patch3: backport-f90124c73edd050b24961197a4abcf17e53b41a8.patch
Patch4: backport-6f7ce73159c02b726a6f0fe0acff961c95e337a8.patch
...
%setup -q -n alsa-utils-1.2.13
cd %{_builddir}/alsa-utils-1.2.13
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a alsa-utils-1.2.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743794159
