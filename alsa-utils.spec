...
Source0  : https://www.alsa-project.org/files/pub/utils/alsa-utils-1.2.2.tar.bz2
...
%prep
%setup -q -n alsa-utils-1.2.2
cd %{_builddir}/alsa-utils-1.2.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582585077
...
cp %{_builddir}/alsa-utils-1.2.2/COPYING %{buildroot}/usr/share/package-licenses/alsa-utils/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
%make_install
