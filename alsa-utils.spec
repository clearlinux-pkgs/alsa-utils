...
Source0  : ftp://ftp.alsa-project.org/pub/utils/alsa-utils-1.1.4.tar.bz2
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: alsa-utils-bin
Requires: alsa-utils-config
Requires: alsa-utils-autostart
...
export LANG=C
export SOURCE_DATE_EPOCH=1495040363
...
%files config
%defattr(-,root,root,-)
%exclude /usr/lib/systemd/system/basic.target.wants/alsa-restore.service
%exclude /usr/lib/systemd/system/basic.target.wants/alsa-state.service
