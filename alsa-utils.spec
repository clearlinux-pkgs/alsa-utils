...
Source0  : https://www.alsa-project.org/files/pub/utils/alsa-utils-1.2.12.tar.bz2
Source1  : https://www.alsa-project.org/files/pub/utils/alsa-utils-1.2.12.tar.bz2.sig
...
%setup -q -n alsa-utils-1.2.12
cd %{_builddir}/alsa-utils-1.2.12
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a alsa-utils-1.2.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718225016
